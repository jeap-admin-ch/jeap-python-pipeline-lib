...
from jeap_pipeline import put_deployment_state, put_to_deployment_log_service, get_previous_deployment_on_environment

class TestDeploymentLogOperations(unittest.TestCase):
    @patch('jeap_pipeline.deployment_log_operations.__request_deployment_log_service')
